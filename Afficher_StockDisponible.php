<?php
include"connect.php";
$req="SELECT Id_stock,Date_stock,Denomination,Forme,Dosage,Stock_disponible,Prix_U,Prix_T FROM registre_stock INNER JOIN listemedicament ON registre_stock.Id_medicament=listemedicament.Id_Medicament";
